...
CREATE TABLE `student` (
    ...
    `next_room_id` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `student` ADD CONSTRAINT `student_next_room_id_fkey` FOREIGN KEY (`next_room_id`) REFERENCES `room`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `belonging` ADD CONSTRAINT `belonging_warehouse_id_fkey` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouse`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
