...
CREATE TABLE room (
    ...
    CONSTRAINT hostel_room FOREIGN KEY (hostel_id) REFERENCES hostel(id)
    ON DELETE RESTRICT
    ON UPDATE CASCADE
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE student (
    ...
    CONSTRAINT current_room FOREIGN KEY (current_room_id) REFERENCES room(id)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,

    CONSTRAINT next_room FOREIGN KEY (next_room_id) REFERENCES room(id)
    ON DELETE RESTRICT
    ON UPDATE CASCADE
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
